    ...
    constructor(argOne, argTwo) {
        ...
        this.ResolveTailComponents = (rootTarget) => {
            ...
            for (let ii = 1; ii < this.components.length; ++ii) {
                ...
                let foundFlow = TypeAssertion_1.asOrNull(foundComponent, FlowBase_1.FlowBase);
                if (foundFlow !== null) {
        ...
        this.GetChildFromContext = (context, childName, minimumLevel, forceDeepSearch = false) => {
            ...
            const weaveContext = TypeAssertion_1.asOrNull(context, Weave_1.Weave);
            if (childName &&
                weaveContext !== null &&
            ...
            let flowContext = TypeAssertion_1.asOrNull(context, FlowBase_1.FlowBase);
