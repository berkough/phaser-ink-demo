...
export declare abstract class ParsedObject {
    ...
    readonly Find: <T extends ParsedObject>(type: (Function & {
        prototype: T;
    }) | (new (...arg: any[]) => T)) => (queryFunc?: FindQueryFunc<T> | null) => T | null;
    readonly FindAll: <T extends ParsedObject>(type: (Function & {
        prototype: T;
    }) | (new (...arg: any[]) => T)) => (queryFunc?: FindQueryFunc<T> | undefined, foundSoFar?: T[] | undefined) => T[];
