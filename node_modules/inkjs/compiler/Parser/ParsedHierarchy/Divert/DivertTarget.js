...
class DivertTarget extends Expression_1.Expression {
    constructor(divert) {
        ...
        this.Equals = (obj) => {
            const otherDivTarget = TypeAssertion_1.asOrNull(obj, DivertTarget);
            if (!otherDivTarget ||
                !this.divert.target ||
    ...
    ResolveReferences(context) {
        ...
        if (targetContent !== null) {
            ...
            if (target !== null) {
                ...
                const parentFunc = TypeAssertion_1.asOrNull(this.parent, FunctionCall_1.FunctionCall);
            ...
            //
            let targetFlow = TypeAssertion_1.asOrNull(targetContent, FlowBase_1.FlowBase);
