...
class Divert extends Object_1.ParsedObject {
    constructor(target, args) {
                ...
                if (requiresArgCodeGen) {
                    ...
                    for (let ii = 0; ii < this.args.length; ++ii) {
                        ...
                        if (argExpected && argExpected.isByReference) {
                            const varRef = TypeAssertion_1.asOrNull(argToPass, VariableReference_1.VariableReference);
                            if (!varRef) {
        ...
        this.ResolveTargetContent = () => {
            ...
            if (this.targetContent === null) {
                ...
                if (variableTargetName !== null) {
                    const flowBaseScope = TypeAssertion_1.asOrNull(ClosestFlowBase_1.ClosestFlowBase(this), FlowBase_1.FlowBase);
                    if (flowBaseScope) {
        ...
        this.CheckArgumentValidity = () => {
            ...
            const targetFlow = TypeAssertion_1.asOrNull(this.targetContent, FlowBase_1.FlowBase);
            // No error, crikey!
            ...
            for (let ii = 0; ii < paramCount; ++ii) {
                ...
                if (flowArg.isDivertTarget) {
                    ...
                    let varRef = TypeAssertion_1.asOrNull(divArgExpr, VariableReference_1.VariableReference);
    ...
    ResolveReferences(context) {
        ...
        let targetFlow = TypeAssertion_1.asOrNull(this.targetContent, FlowBase_1.FlowBase);
        if (targetFlow) {
