    ...
    constructor(functionName, args) {
        ...
        this.GenerateIntoContainer = (container) => {
            ...
            if (this.isChoiceCount) {
                ...
                const divertTarget = TypeAssertion_1.asOrNull(this.args[0], DivertTarget_1.DivertTarget);
                const variableDivertTarget = TypeAssertion_1.asOrNull(this.args[0], VariableReference_1.VariableReference);
                ...
                for (let ii = 0; ii < this.args.length; ii += 1) {
                    const num = TypeAssertion_1.asOrNull(this.args[ii], NumberExpression_1.NumberExpression);
                    if (num && !num.isInt()) {
                ...
                const num = TypeAssertion_1.asOrNull(this.args[0], NumberExpression_1.NumberExpression);
                if (num && !num.isInt()) {
