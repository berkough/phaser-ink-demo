...
class InkParser extends StringParser_1.StringParser {
    constructor(str, filename = null, externalErrorHandler = null, rootParser = null, fileHandler = null) {
        ...
        this.RuleDidSucceed = (result, stateAtStart, stateAtEnd) => {
            ...
            const parsedObj = TypeAssertion_1.asOrNull(result, Object_1.ParsedObject);
            if (parsedObj) {
            ...
            if (parsedListObjs !== null) {
                for (const parsedListObj of parsedListObjs) {
                    const singleObj = TypeAssertion_1.asOrNull(parsedListObj, Object_1.ParsedObject);
                    if (!singleObj)
                        continue;
            ...
            const id = TypeAssertion_1.asOrNull(result, Identifier_1.Identifier);
            if (id != null) {
        ...
        this.Choice = () => {
            ...
            if (diverts !== null) {
                for (const divObj of diverts) {
                    ...
                    const div = TypeAssertion_1.asOrNull(divObj, Divert_1.Divert);
                ...
                if (isArrow) {
                    ...
                    if (arrowsAndDiverts[ii] === "->->") {
                        ...
                        if (ii < arrowsAndDiverts.length - 1) {
                            const tunnelOnwardDivert = TypeAssertion_1.asOrNull(arrowsAndDiverts[ii + 1], Divert_1.Divert);
        ...
        this.LogicLine = () => {
            ...
            const funCall = TypeAssertion_1.asOrNull(result, FunctionCall_1.FunctionCall);
            if (funCall) {
        ...
        this.InlineLogic = () => {
            ...
            let contentList = TypeAssertion_1.asOrNull(logic, ContentList_1.ContentList);
            if (!contentList) {
